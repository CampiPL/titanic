...
def main():
	...
	st.set_page_config(page_title="Czy przeżyjesz katastrofę??")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://media.istockphoto.com/id/454055827/pl/wektor/titanic-zaton%C4%85%C5%82-transatlantycki-lodowa.jpg?s=612x612&w=0&k=20&c=REmK9Qh621JaIkQbBJB4AY66KKb5RMVW0xHczxOIz4w=")

	with overview:
		st.title("Czy przeżyjesz katastrofę??")
